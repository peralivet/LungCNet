...
The dataset for this project can be found here:![Project Dataset Link](https://www.kaggle.com/datasets/adityamahimkar/iqothnccd-lung-cancer- dataset/data).

There are three files for the project because three different experiments were run for the project. All three files are included in this project as well as a detailed report(dissertation report) on how everything was achieved.
